<?php
/**
 * @file Contains \Drupal\authorize_forms\AuthorizeForms
 */
...
class AuthorizeForms {
    ...
    public function setSettings($settings) {
        ...
        $this->merchant_login_id = $settings['merchant_login_id'];
        $this->merchant_transaction_key = $settings['merchant_transaction_key'];
        $this->response_ok = $settings['response_ok'];
